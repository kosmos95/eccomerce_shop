...
import static shop.study.entity.QItem.item;
import static shop.study.entity.QItemImg.itemImg;

public class ItemRepositoryCustomImpl implements ItemRepositoryCustom{ //268p
